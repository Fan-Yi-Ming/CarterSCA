...
class UsimCPA:
    ...
    def report(self):
        for i in self.sbox_index_arr:
            report_sbox_key_guesses(i,
                                    self.sbox_key_arr_3d[self.attack_round_index][i],
                                    self.sbox_keyvalue_arr_3d[self.attack_round_index][i],
                                    self.sbox_keypos_arr_3d[self.attack_round_index][i],
    ...
    def analyze(self):
        ...
        for i in self.sbox_index_arr:
            ...
            (self.sbox_key_arr_3d[self.attack_round_index][i],
             self.sbox_keyvalue_arr_3d[self.attack_round_index][i],
             self.sbox_keypos_arr_3d[self.attack_round_index][i]) = rank_sbox_key_guesses(correlation_arr_2d,
                                                                                          self.candidates)
