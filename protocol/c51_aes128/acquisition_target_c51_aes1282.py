...
from protocol.gatherer_sds804x2 import GathererSDS804X2
...
if __name__ == '__main__':
    ...
    gatherer_sds804x_arm_delay = 0.0
    ...
    # 示波器初始化
    gatherer_sds804x = GathererSDS804X2()
    gatherer_sds804x.open_instrument(gatherer_sds804x_resource_name)
    gatherer_sds804x.arm(gatherer_sds804x_arm_delay)
    gatherer_sds804x.snapshot_channels_parameters(timeout=gatherer_sds804x_acquisition_timeout)
